...
def function5():
    ...
    z = np.zeros(20).reshape(5,4) #wrtie your code here
...
def function8():
    ...
    x = np.ones(10,dtype=np.uint32)
    x = (x*6).reshape(2,5) #write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.tile(arr,(1,3))
    ans= np.hstack(ans)#write your code here 
...
def function15():
    ...
    ans=arr[np.lexsort(arr[:,::-1].T)]#write your code here 
...
def function17():
    ...
    arr = np.where((arr%3==0)&(arr%5==0),'YES',arr)
    arr=np.where(arr!='YES','NO',arr)
...
def function19():
    ...
    W = np.empty_like(X); W[:] = X;;W=W.T  # Write your code here 
    b = 5  # Write your code here
    output = (X*W)+b;return output   # Write your code here
...
def fucntion20():
    ...
    return np.array(list(map(xyz, x)))#Write your Code here
